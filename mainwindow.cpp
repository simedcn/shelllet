    ...
    tray_(QIcon(":/new/app/favicon.png"))
{
    ...
    ui->tableView->horizontalHeader()->setSectionResizeMode(Column_Name, QHeaderView::Fixed);
    ui->tableView->horizontalHeader()->setSectionResizeMode(Column_Cmd, QHeaderView::ResizeToContents);
    ui->tableView->horizontalHeader()->setSectionResizeMode(Column_Env, QHeaderView::Stretch);
